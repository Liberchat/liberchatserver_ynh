...
**LiberChat v7.0.2** est une application de messagerie instantanée ultra-sécurisée avec chiffrement de bout en bout de haut niveau.
...
|-------------|-------|-------------|
| **LiberChat v7.0.2** | 10/10 | AES-GCM + X25519 + HKDF (Unifié) |
