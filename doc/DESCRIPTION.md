...
**LiberChat v7.0.4** est une application de messagerie instantanée ultra-sécurisée avec chiffrement de bout en bout de haut niveau.
...
|-------------|-------|-------------|
| **LiberChat v7.0.4** | 10/10 | AES-GCM + X25519 + HKDF (Unifié) |
