...
import { Reply, SmilePlus, Pencil, Trash2, X } from 'lucide-react';
        ...
        {showMenu && (
          isMobile() ? (
            <div className="fixed inset-0 z-50" style={{ pointerEvents: 'none' }}>
              ...
              >
                <button
                  className="flex items-center gap-2 w-full text-left px-3 py-1.5 rounded-xl hover:bg-red-700/80 hover:text-white active:scale-95 transition-all duration-150"
                  onClick={e => { e.stopPropagation(); handleReplyMenu(); }}
                  aria-label="Répondre à ce message"
                >
                  <Reply size={16} /> {t.chat.reply}
                </button>
                <button
                  className="flex items-center gap-2 w-full text-left px-3 py-1.5 rounded-xl hover:bg-red-700/80 hover:text-white active:scale-95 transition-all duration-150"
                ...
                >
                  <SmilePlus size={16} /> {t.chat.react}
                </button>
                ...
                {isOwnMessage && message.type === 'text' && (
                  <button
                    className="flex items-center gap-2 w-full text-left px-3 py-1.5 rounded-xl text-red-400 font-mono hover:bg-red-700/80 hover:text-white border-t border-red-700 transition-all duration-150 active:scale-95"
                ...
                <button
                  className="flex items-center gap-2 w-full text-left px-3 py-1.5 rounded-xl text-gray-400 font-mono hover:bg-gray-800 hover:text-white border-t border-red-700 transition-all duration-150 active:scale-95"
            ...
            menuPos && (
              ...
              >
                <button
                  className="flex items-center gap-2 w-full text-left px-4 py-2 hover:bg-red-700/80 hover:text-white transition-colors"
                  onClick={e => { e.stopPropagation(); handleReplyMenu(); }}
                >
                  <Reply size={16} /> {t.chat.reply}
                </button>
                ...
                {isOwnMessage && message.type === 'text' && (
                  <button
                    className="flex items-center gap-2 w-full text-left px-4 py-2 bg-black text-red-400 font-mono hover:bg-red-700/80 hover:text-white border-t border-red-700 transition-colors"
                    onClick={e => { e.stopPropagation(); setShowMenu(false); setIsEditing(true); setEditValue(message.content || ''); }}
                  >
                    <Pencil size={14} /> {t.chat.edit}
                  </button>
                ...
                <button
                  className="flex items-center gap-2 w-full text-left px-4 py-2 bg-black text-red-400 font-mono hover:bg-gray-800 hover:text-white border-t border-red-700 transition-colors"
                  onClick={e => { e.stopPropagation(); handleCloseMenu(); }}
                >
                  <X size={16} /> Annuler
                </button>
