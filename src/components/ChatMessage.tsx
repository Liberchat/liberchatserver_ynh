...
const ChatMessage: React.FC<ChatMessageProps> = ({ 
  ...
  const handleReact = async (emoji: string) => {
    console.log('handleReact appelé avec emoji:', emoji);
    console.log('socket:', !!socket, 'symmetricKey:', !!symmetricKey, 'encryptMessageE2EE:', !!encryptMessageE2EE);
    
    if (!socket || !symmetricKey || !encryptMessageE2EE) {
      console.warn('Réaction impossible: socket, symmetricKey ou encryptMessageE2EE manquant');
          ...
          isMobile() ? (
            <div className="fixed inset-0 z-50" style={{ pointerEvents: 'none' }}>
              ...
              >
                ...
                {showEmojiPicker && (
                  <div 
                    className="absolute z-50 mt-2 border-4 border-red-700 rounded-2xl shadow-2xl bg-black/95 p-2 anarchist-emoji-picker left-1/2 -translate-x-1/2 w-[95vw] max-w-xs sm:left-0 sm:translate-x-0 sm:w-auto sm:max-w-[100vw]" 
                    style={{ minWidth: 200 }}
