...
- **Chiffrement E2EE** (AES-256-GCM) pour la confidentialité
- **Code obfusqué** (protection avancée du code JavaScript)
...
Liberchat intègre **3 niveaux de protection** du code :
...
Le code JavaScript est **pratiquement illisible** en production, rendant l'extraction de la clé de chiffrement extrêmement difficile (plusieurs heures pour un expert).

Voir `PROTECTION_COMPLETE.md` pour plus de détails.
